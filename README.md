...
### Метрики по звонкам (агрегируются каждые 2 минуты)
...
### Метрики по очередям (агрегируются каждые 2 минуты)

Показывают распределение общего количества звонков, среднее время ожидания, уровень сервиса и процент потерянных звонков для каждого типа очереди по-отдельности
